...
class AppTest {
    ...
    @Test
    void createDeliveryPdf() {
        ClassLoader classLoader = AppTest.class.getClassLoader();

        final var xml = "2008202606109170775200120010020000021461234567817.xml";
        final var logo = "logo.jpeg";
        final var reportFolder = classLoader.getResource("./report").getPath();
        final var pdfOutFolder = classLoader.getResource(".").getPath().concat("pdf");
        createDirectory(pdfOutFolder);
        ...
        var report = new DeliveryReport(pathXmlFile, reportFolder, pathLogo, pdfOutFolder);
        assertTrue(report.pdf("2008202606109170775200120010020000021461234567817", "1901-01-01"));
    }

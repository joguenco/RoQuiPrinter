...
public class NotaDebito {
    ...
    public static class InfoNotaDebito {
        ...
        public static class Compensaciones {
             ...
             * JAXB object. This is why there is not a <CODE>set</CODE> method for the compensacion
             * property.
             *
             * <p>For example, to add a new item, do as follows:
             *
        ...
        public static class Impuestos {
             ...
             * <p>This accessor method returns a reference to the live list, not a snapshot.
             * Therefore any modification you make to the returned list will be present inside the
             * JAXB object. This is why there is not a <CODE>set</CODE> method for the impuesto
             * property.
             *
             * <p>For example, to add a new item, do as follows:
             *
        ...
        public static class Pagos {
             ...
             * <p>This accessor method returns a reference to the live list, not a snapshot.
             * Therefore any modification you make to the returned list will be present inside the
             * JAXB object. This is why there is not a <CODE>set</CODE> method for the pago
             * property.
             *
             * <p>For example, to add a new item, do as follows:
             *

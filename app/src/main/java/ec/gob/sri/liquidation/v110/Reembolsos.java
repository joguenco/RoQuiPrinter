...
/**
 * Java class for reembolsos complex type.
 *
...
public class Reembolsos {
   ...
   * there is not a <CODE>set</CODE> method for the reembolsoDetalle property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Reembolsos.ReembolsoDetalle
   * }
   */

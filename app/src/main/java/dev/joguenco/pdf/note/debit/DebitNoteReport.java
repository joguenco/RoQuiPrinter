...
public class DebitNoteReport {
                    ...
                    JasperFillManager.fillReport(
                            ...
                            obtenerMapaParametrosReportes(
                                    getParametersInfoTriobutaria(
                                            rep.getNotaDebito().getInfoTributaria(), numAut, fechaAut),
                                    getInfoCN(rep.getNotaDebito().getInfoNotaDebito(), rep)),
    ...
    private Map<String, Object> getInfoCN(NotaDebito.InfoNotaDebito infoCN, DebitNoteTemplate nc) {
        ...
        param.put("RAZON_MODIF", "TODO");
        String porcentajeIva = "-1";

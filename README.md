...
### GNU/Linux or MacOS
```
mvn install:install-file -Dfile=./app/build/libs/RoQuiPrinter-2.0.0.jar -DgroupId=dev.joguenco.printer -DartifactId=RoQuiPrinter -Dversion=2.0.0 -Dpackaging=jar
```
### Windows
